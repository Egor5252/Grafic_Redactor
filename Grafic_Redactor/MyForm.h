...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->дугаToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->линияToolStripMenuItem->Size = System::Drawing::Size(109, 22);
			this->линияToolStripMenuItem->Text = L"Линия";
			// 
			// дугаToolStripMenuItem
			// 
			this->дугаToolStripMenuItem->Name = L"дугаToolStripMenuItem";
			this->дугаToolStripMenuItem->Size = System::Drawing::Size(109, 22);
			this->дугаToolStripMenuItem->Text = L"Дуга";
			// 
			// MyForm
			// 
...
#pragma endregion
	...
	private: System::Void contextMenuStrip1_ItemClicked(System::Object^ sender, System::Windows::Forms::ToolStripItemClickedEventArgs^ e) {
		...
		if (e->ClickedItem == this->contextMenuStrip1->Items->Find("линияToolStripMenuItem", false)[0])
		{
			finished = false;
		}
		else
